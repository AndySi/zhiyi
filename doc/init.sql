...
CREATE TABLE `t_ws_about_list` (
  ...
  `content` text,
  `aboutId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
